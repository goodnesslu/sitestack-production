    ...
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="lg:mt-20">
          <p className="text-center z-[10]">Run your business, in one place</p>
      ...
      <section className="flex justify-center items-center flex-col gap-4 lg:!mt-60 md:!mt-20 mt-[-60] pl-14 pr-14 mb-40">
          ...
          {prices.data.map((card) => (
            ...
            <Card
              ...
              className={clsx("w-[300px] flex flex-col justify-between", {
                "border-2 border-primary": card.nickname === "Growth",
              })}
            >
              <CardHeader>
                <CardTitle
                  className={clsx("", {
                    "text-muted-foreground": card.nickname !== "Growth",
                  })}
                >
                  {card.nickname}
                </CardTitle>
              ...
              <CardFooter className="flex flex-col items-start gap-4">
                ...
                <Link
                  ...
                  className={clsx(
                    ...
                    { "!bg-muted-foreground": card.nickname !== "Growth" }
                  )}
                >
                  Get Started
                </Link>
